...
const ACCEPTED_TYPES = ".pdf,.txt,.docx,.md,.pptx,.jpg,.jpeg,.png,.webp,.mp4,.mkv,.avi,.mov,.webm,.mp3,.wav,.m4a,.ogg,.eml,.msg";
            ...
            {isDragOver ? (
              ...
              >
                ...
                <p className="text-[10px] text-muted-foreground/60 mt-0.5">
                  PDF, DOCX, PPTX, TXT, MD, Images, Audio, Video, Emails (max {MAX_SIZE_MB}MB)
                </p>
              </motion.div>
            )}
          </AnimatePresence>
