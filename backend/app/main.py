...
app = FastAPI(
    ...
    description="ORION — Knowledge Base with semantic search, knowledge graph, and LLM chat",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc",
...
# Video frames static path — video frames extracted by Orion multimodal parser
_frames_dir = Path(__file__).resolve().parent.parent / "data" / "frames"
