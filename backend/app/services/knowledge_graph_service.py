...
class KnowledgeGraphService:
    ...
    def __init__(
        ...
        self.kg_language = kg_language or settings.ORION_KG_LANGUAGE
        self.kg_entity_types = kg_entity_types or settings.ORION_KG_ENTITY_TYPES
        self._rag = None
    ...
    async def _get_rag(self):
        ...
        self._rag = LightRAG(
            ...
            chunk_token_size=settings.ORION_KG_CHUNK_TOKEN_SIZE,
    ...
    async def query(
        ...
        try:
            ...
            logger.warning(
                f"KG query timed out after {settings.ORION_KG_QUERY_TIMEOUT}s "
